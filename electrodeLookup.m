...
%   this text has last been altered 29-05-2012  12:35
%   

function num=electrodeLookup(electrode)
% Debug code commented below. 
% 
% fprintf('Available electrodes to resolve to channel number: Fp1,Fpz,Fp2,F7,F3,Fz,F4,F8,FC5,FC1,\nFC2,FC6,M1,T7,C3,Cz,C4,T8,M2,CP5,CP1,CP2,CP6,P7,P3,Pz,P4,P8,POz,O1,Oz,O2,AF7,AF3,AF4,\nAF8,F5,F1,F2,F6,FC3,FCz,FC4,C5,C1,C2,C6,CP3,CPz,CP4,P5,P1,P2,P6,PO5,PO3,PO4,PO6,FT7,FT8,TP7,TP8,PO7,PO8\n\n')
